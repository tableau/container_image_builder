...
DRIVERS=amazon_athena,amazon_emr_hadoop_hive,amazon_redshift,cloudera_hive,cloudera_impala,datorama,dremio,exasol,ibm_db2,jaybird,mapr_drill,mariadb,microsoft_sharepoint_lists,microsoft_sql_server,mysql,odps,oracle,oracle_essbase,oracle_netsuite,postgresql,qubole,salesforce_cdp,salesforce_marketing_cloud,sap_success_factors,simba_spark,singlestore,snowflake,trino,vertica
